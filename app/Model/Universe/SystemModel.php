...
class SystemModel extends AbstractUniverseModel {
     ...
     * @return double
     */
    public function set_securityStatus(string|int|float $secStatus) : float {
     ...
     * @return string|null
     */
    public function set_effect(string $effect) : string|null {
     ...
     * @param $pkeys
     */
    public function afterUpdateEvent(self $self, array<int|string, mixed> $pkeys) : bool {
        // build search index
        $self->buildIndex();
